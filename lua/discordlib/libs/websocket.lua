...
function WS.Connection.Create(bsock,isServer,destination_info) --Takes fully enstablished bromsock and bool for being server
	...
	self.auth = "Bot MTk4NjIyNDgzNDcxOTI1MjQ4.Cl2FMQ.ZnCjm1XVW7vRze4b7Cq4se7kKWs"
...
function fSetCallbackReceive(func)
...
function WS.Connection:SendHTTPHandShake()
	...
	--	if(self.auth) then
	--		packet:WriteLine("Authorization: ".. self.auth )
	--	end
		packet:WriteLine("Authorization: Bot MjE4MDA3ODQyNDQ2MjQ1ODg5.Cs1EmQ.CJR1uvH_jXnK-hqBEKCQAvqxT9w")
